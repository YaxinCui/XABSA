...
def init_args():
    ...
    output_dir = f"outputsabsa/{args.tfm_type}-{args.src_lang}-{args.tgt_lang}-{args.exp_type}"
...
def main():
    ...
    if args.do_eval:
        ...
        log_file_path = f"{results_log_dir}/{args.tfm_type}-{args.exp_type}-{args.src_lang}-{args.tgt_lang}.txt"
